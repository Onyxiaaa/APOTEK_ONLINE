...
<body style="background-color:rgb(77, 173, 254)">
  <div class="container">
    <div class="login-box">
      ...
      <center>
        ...
        <h2 style="color:white">APOTEK ONLINE</h2>
        <h3 style="color:white">OBAT-OBATAN</h3>
        ...
        <form action="periksa_login.php" method="POST">
          ...
          <div class="row">
            <div class="col-xs-offset-8 col-xs-4">
              <button type="submit" class="btn btn-block btn-flat" style="background-color:rgb(77, 173, 254);color:white">LOGIN</button>
            </div>
          </div>
        </form>
